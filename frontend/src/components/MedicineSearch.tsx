...
import { searchMedicines } from '../lib/mongodb';
    ...
    <section className="py-20 bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(5)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute rounded-full bg-gradient-to-r from-blue-600/20 via-blue-500/20 to-cyan-500/20"
            animate={{
        ...
        <div className="text-center mb-12">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white">
              Search for <span className="bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 text-transparent bg-clip-text">Medicine</span> Search
            </h2>
        ...
        >
          <form onSubmit={handleSearch} className="relative">
            <div className="flex items-center overflow-hidden rounded-lg bg-gray-800 border border-gray-700 shadow-lg">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 text-white px-6 py-4 font-medium hover:opacity-90 transition-opacity"
              >
                Search
              </button>
            </div>
                  ...
                  >
                    <div className="flex-shrink-0 mr-4">
                      {medicine.image_url ? (
                        ...
                        <div className="h-16 w-16 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 rounded-md flex items-center justify-center">
