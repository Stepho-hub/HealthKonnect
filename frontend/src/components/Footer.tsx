...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-br from-blue-900 via-blue-800 to-cyan-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-gray-400">
              Ensuring quality healthcare through telemedicine.
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/medicines" className="text-gray-400 hover:text-white transition-colors">Herbal Medicines</Link>
              </li>
              <li>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  HealthKonnect<br />
                  Catherine Ndereba Road<br />
                  Edeka Plaza
                </span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-red-500 mr-2 flex-shrink-0" />
                <span className="text-gray-400">+254746852868</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-red-500 mr-2 flex-shrink-0" />
                <span className="text-gray-400">somtechhub@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
