...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden pt-24">
      ...
      <motion.div
        className="absolute left-0 top-0 w-32 h-full bg-gradient-to-r from-blue-400/20 to-transparent"
      ...
      <motion.div
        className="absolute right-0 top-0 w-32 h-full bg-gradient-to-l from-purple-400/20 to-transparent"
        initial={{ x: 100, opacity: 0 }}
        animate={{ x: 0, opacity: 1 }}
