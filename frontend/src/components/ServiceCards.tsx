            ...
            >
              <div className="p-6">
                <div className="flex justify-center">
                  <div className="h-14 w-14 rounded-full bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 flex items-center justify-center">
                    {service.icon}
                  </div>
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 flex items-center justify-center opacity-0 group-hover:opacity-95 transition-opacity duration-300 p-6">
