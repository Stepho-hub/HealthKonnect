...
router.get('/profile', async (req, res) => {
    try {
        ...
        const profile = await models_1.ProfileModel.findOne({ clerkId: req.user.clerkId });
...
router.put('/profile', async (req, res) => {
    try {
        ...
        const profile = await models_1.ProfileModel.findOneAndUpdate({ clerkId: req.user.clerkId }, {
            ...updates,
